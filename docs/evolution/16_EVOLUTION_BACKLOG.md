...
| EVO-004 | Modelos tipados de lectura | EVOLUTION-2 | IN_PROGRESS | P1 | M | Diez consultas tipadas; SQL sin cambios; CI y Pixel 8 en verde |
| EVO-005 | Exportación CSV | EVOLUTION-2 | IN_PROGRESS | P1 | M | Dart puro, sin dependencia; falta abrirlo en una hoja de cálculo real |
| EVO-006 | Exportación PDF | EVOLUTION-2 | IN_PROGRESS | P1 | M | Escritor propio por ADR-001; PDF verificado en el visor de Android |
