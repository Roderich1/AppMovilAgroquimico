...
| **STAB-008** | Debe poder producirse una release publicable | Release firmada con la clave de depuración | `android/app/build.gradle.kts`, `key.properties.example`, `.gitignore` | Verificación manual: APK sin entradas de firma en `META-INF` | `20_BUILD_AND_CONFIGURATION.md`, `23_SECURITY_AUDIT.md` S-01 | ✅ FIXED (bloqueo externo: keystore) |
